    ...
    <section class="container bg-dark p-4 rounded-top mb-5 results-page">
        ...
        <div class="results" >
            ...
            <div class="row" id="resultsContainer">
                <div class="col-md-3">
                    <figure class="card">
                        <img src="./assets/img/img_lower-1.png" class="card-img-top" alt="...">
                        <div class="card-body">
                          <figcaption class="card-title fs-5">
                            Dr. Lorenzo Fernández
                          </figcaption>
                          <ul class="fs-6">
                            <li>
                          ...
                          <a href="./details.html" class="btn btn-key">Ver perfil</a>
                        </div>
                    </figure>
                </div><!-- end card -->
                ...
                <div class="col-md-3">
                    <figure class="card">
                        <img src="undefined" class="card-img-top" alt="Imagen de John Doe">
                        <div class="card-body">
                            <figcaption class="card-title fs-5">
                                John Doe
                            </figcaption>
                            ...
                            <a href="./details.html?id=undefined" class="btn btn-key">Ver perfil</a>
                        </div>
                    </figure>
                </div>
                ...
                <div class="col-md-3">
                    <figure class="card">
                        <img src="./assets/img/img_lower-2.png" class="card-img-top" alt="...">
                        <div class="card-body">
                          <figcaption class="card-title fs-5">
                            Dr. Lorenzo Fernández
                          </figcaption>
                ...
                <div class="col-md-3">
                    <figure class="card">
                        <img src="./assets/img/img_lower-3.png" class="card-img-top" alt="...">
                        <div class="card-body">
                          <figcaption class="card-title fs-5">
                            Dr. Lorenzo Fernández
                          </figcaption>
                ...
                <div class="col-md-3">
                    <figure class="card">
                        <img src="./assets/img/img_lower-4.png" class="card-img-top" alt="...">
                        <div class="card-body">
                          <figcaption class="card-title fs-5">
                            Dr. Lorenzo Fernández
                          </figcaption>
                ...
                <div class="col-md-3">
                    <figure class="card">
                        ...
                        <div class="card-body">
                          ...
                          <a href="./details.php" class="btn btn-key">Ver perfil</a>
                        </div>
                    </figure>
                </div><!-- end card -->
            </div><!-- end row -->
