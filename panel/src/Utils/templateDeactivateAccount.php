...
<body>
    ...
    <div style="width: 80%; margin: auto; padding: 6px;">
        <h1 style="color:#033333; font-size:20px; font-family: Encode Sans, sans-serif; font-weight: 600;">
            Tu cuenta está inactiva, '.$name.'
        </h1>
        <p style="color:#033333; font-family: Encode Sans, sans-serif; line-height: 22px;">
            Hemos revisado tu solicitud y, por el momento, tu cuenta en Lexor se encuentra <strong>inactiva</strong>. 
            Esto puede deberse a una de las siguientes razones:
        </p>
        
        <ul style="color:#033333; font-family: Encode Sans, sans-serif; line-height: 22px;">
            <li>El pago de tu suscripción aún no ha sido recibido.</li>
            <li>Faltan datos o documentos necesarios para validar tu identidad.</li>
        </ul>

        <p style="color:#033333; font-family: Encode Sans, sans-serif; line-height: 22px;">
            Para regularizar tu situación y activar tu cuenta, por favor <strong>contáctanos</strong>.
        </p>

        <img src="https://www.lexorabogados.com.ar/panel/assets/img/lines-reverse.svg" alt="" style="width: 200px;">
        
        <h2 style="color:#033333; font-size:20px; font-family: Encode Sans, sans-serif; font-weight: 600;">Contáctanos por WhatsApp</h2>
        <p style="color:#033333; font-family: Encode Sans, sans-serif; line-height: 22px;">
            Para resolver este inconveniente de manera rápida, envíanos un mensaje a nuestro equipo de soporte a través de WhatsApp.
        </p>
        ...
        <h2 style="color:#033333; font-size:20px; font-family: Encode Sans, sans-serif; font-weight: 600;">¿Tienes dudas?</h2>
        <p style="color:#033333; font-family: Encode Sans, sans-serif; line-height: 22px;">
            Estamos aquí para ayudarte. No dudes en comunicarte con nuestro equipo de soporte si necesitas más información.
        </p>
